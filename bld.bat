...
cmake "%SRC_DIR%\opencv" ^
    ...
    -DProtobuf_PROTOC_EXECUTABLE="%LIBRARY_PREFIX_FWD%/bin/protoc.exe" ^
    -DProtobuf_INCLUDE_DIR="%LIBRARY_PREFIX_FWD%/include" ^
    -DProtobuf_LIBRARY="%LIBRARY_PREFIX_FWD%/lib/libprotobuf.lib" ^
